...
require (
	...
	github.com/jeremmfr/go-netconf v0.6.0
...
replace github.com/hashicorp/terraform-plugin-sdk/v2 => github.com/jeremmfr/terraform-plugin-sdk/v2 v2.36.2-0.20250404064500-35eb7b56554b
