...
func TestAccJunosForwardingoptionsSampling_basic(t *testing.T) {
	if os.Getenv("TESTACC_SRX") != "" {
		resource.Test(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Config: testAccJunosForwardingoptionsSamplingConfigCreate(),
				},
				{
					Config: testAccJunosForwardingoptionsSamplingConfigUpdate(),
				},
				{
...
func testAccJunosForwardingoptionsSamplingConfigCreate() string {
	return `
...
func testAccJunosForwardingoptionsSamplingConfigUpdate() string {
	return `
resource "junos_forwardingoptions_sampling" "testacc_sampInstance" {
  depends_on = [
    junos_interface_logical.testacc_sampInstance,
