...
func TestAccJunosServicesFlowMonitoringV9Template_basic(t *testing.T) {
	if os.Getenv("TESTACC_ROUTER") != "" {
		resource.Test(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Config: testAccJunosServicesFlowMonitoringV9TemplateConfigCreate(),
				},
				{
					Config: testAccJunosServicesFlowMonitoringV9TemplateConfigUpdate(),
				},
				{
...
func testAccJunosServicesFlowMonitoringV9TemplateConfigCreate() string {
	return `
...
func testAccJunosServicesFlowMonitoringV9TemplateConfigUpdate() string {
	return `
resource "junos_services_flowmonitoring_v9_template" "testacc_flow_v9_template_ipv4" {
  name                         = "testacc_template@1"
  type                         = "ipv4-template"
