...
func TestAccJunosPolicyoptionsPolicyStatementUpgradeStateV0toV1_basic(t *testing.T) {
			...
			Steps: []resource.TestStep{
				{
					...
					Config: testAccJunosPolicyoptionsPolicyStatementConfigV0(),
				},
				{
...
func testAccJunosPolicyoptionsPolicyStatementConfigV0() string {
	return `
