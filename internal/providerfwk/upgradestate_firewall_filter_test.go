...
func TestAccJunosFirewallFilterUpgradeStateV0toV1_basic(t *testing.T) {
			...
			Steps: []resource.TestStep{
				{
					...
					Config: testAccJunosFirewallFilterConfigV0(),
				},
				{
...
func testAccJunosFirewallFilterConfigV0() string {
	return `
