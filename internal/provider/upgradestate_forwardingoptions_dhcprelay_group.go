...
func (rsc *forwardingoptionsDhcprelayGroup) UpgradeState(_ context.Context) map[int64]resource.StateUpgrader {
	return map[int64]resource.StateUpgrader{
		0: {
			...
			StateUpgrader: upgradeForwardingoptionsDhcprelayGroupV0toV1,
		},
	}
}

func upgradeForwardingoptionsDhcprelayGroupV0toV1(
	...
	var dataV1 forwardingoptionsDhcprelayGroupData
	dataV1.ID = dataV0.ID
	...
	for _, blockV0 := range dataV0.Interface {
		blockV1 := forwardingoptionsDhcprelayGroupBlockInterface{
			Name:                                 blockV0.Name,
		...
		if len(blockV0.OverridesV4) > 0 {
			blockV1.OverridesV4 = &forwardingoptionsDhcprelayBlockOverridesV4{
				AllowNoEndOption:             blockV0.OverridesV4[0].AllowNoEndOption,
				AllowSnoopedClients:          blockV0.OverridesV4[0].AllowSnoopedClients,
				NoAllowSnoopedClients:        blockV0.OverridesV4[0].NoAllowSnoopedClients,
				AlwaysWriteGiaddr:            blockV0.OverridesV4[0].AlwaysWriteGiaddr,
				AlwaysWriteOption82:          blockV0.OverridesV4[0].AlwaysWriteOption82,
				...
				DelayAuthentication:          blockV0.OverridesV4[0].DelayAuthentication,
				DeleteBindingOnRenegotiation: blockV0.OverridesV4[0].DeleteBindingOnRenegotiation,
				DisableRelay:                 blockV0.OverridesV4[0].DisableRelay,
				DualStack:                    blockV0.OverridesV4[0].DualStack,
				InterfaceClientLimit:         blockV0.OverridesV4[0].InterfaceClientLimit,
				Layer2UnicastReplies:         blockV0.OverridesV4[0].Layer2UnicastReplies,
				NoBindOnRequest:              blockV0.OverridesV4[0].NoBindOnRequest,
				NoUnicastReplies:             blockV0.OverridesV4[0].NoUnicastReplies,
				ProxyMode:                    blockV0.OverridesV4[0].ProxyMode,
				RelaySource:                  blockV0.OverridesV4[0].RelaySource,
				ReplaceIPSourceWithGiaddr:    blockV0.OverridesV4[0].ReplaceIPSourceWithGiaddr,
				SendReleaseOnDelete:          blockV0.OverridesV4[0].SendReleaseOnDelete,
				TrustOption82:                blockV0.OverridesV4[0].TrustOption82,
				UserDefinedOption82:          blockV0.OverridesV4[0].UserDefinedOption82,
			}
		}
		if len(blockV0.OverridesV6) > 0 {
			blockV1.OverridesV6 = &forwardingoptionsDhcprelayBlockOverridesV6{
				AllowSnoopedClients:                     blockV0.OverridesV6[0].AllowSnoopedClients,
				NoAllowSnoopedClients:                   blockV0.OverridesV6[0].NoAllowSnoopedClients,
				...
				DelayAuthentication:                     blockV0.OverridesV6[0].DelayAuthentication,
				...
				NoBindOnRequest:                         blockV0.OverridesV6[0].NoBindOnRequest,
				RelaySource:                             blockV0.OverridesV6[0].RelaySource,
				SendReleaseOnDelete:                     blockV0.OverridesV6[0].SendReleaseOnDelete,
			}
		}
