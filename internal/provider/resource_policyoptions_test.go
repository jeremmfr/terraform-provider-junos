			...
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeTestCheckFunc(
						...
						resource.TestCheckTypeSetElemAttr("junos_policyoptions_prefix_list.testacc_policyOptions",
							"prefix.*", "192.0.2.0/25"),
						resource.TestCheckResourceAttr("junos_policyoptions_route_filter_list.testacc_policyOptions",
							"address.#", "2"),
						resource.TestCheckTypeSetElemNestedAttrs("junos_policyoptions_route_filter_list.testacc_policyOptions",
						...
						resource.TestCheckResourceAttr("junos_policyoptions_source_address_filter_list.testacc_policyOptions",
							"address.#", "2"),
						resource.TestCheckTypeSetElemNestedAttrs("junos_policyoptions_source_address_filter_list.testacc_policyOptions",
							"address.*", map[string]string{
								"address": "192.0.2.0/25",
								"option":  "exact",
							}),
						...
						resource.TestCheckResourceAttr("junos_policyoptions_policy_statement.testacc_policyOptions",
							"from.prefix_list_filter.#", "1"),
						resource.TestCheckTypeSetElemNestedAttrs("junos_policyoptions_policy_statement.testacc_policyOptions",
							"from.prefix_list_filter.*", map[string]string{
						...
						resource.TestCheckResourceAttr("junos_policyoptions_policy_statement.testacc_policyOptions",
							"from.route_filter.#", "2"),
						resource.TestCheckTypeSetElemNestedAttrs("junos_policyoptions_policy_statement.testacc_policyOptions",
							"from.route_filter.*", map[string]string{
								"route":  "192.0.2.0/25",
								"option": "exact",
							}),
						resource.TestCheckTypeSetElemNestedAttrs("junos_policyoptions_policy_statement.testacc_policyOptions",
						...
						resource.TestCheckResourceAttr("junos_policyoptions_policy_statement.testacc_policyOptions",
							"from.route_filter_list.#", "1"),
						resource.TestCheckTypeSetElemAttr("junos_policyoptions_policy_statement.testacc_policyOptions",
							"from.route_filter_list.*", "testacc policyOptions"),
						resource.TestCheckResourceAttr("junos_policyoptions_policy_statement.testacc_policyOptions",
							"from.source_address_filter.#", "1"),
						resource.TestCheckTypeSetElemNestedAttrs("junos_policyoptions_policy_statement.testacc_policyOptions",
							"from.source_address_filter.*", map[string]string{
								"address": "192.0.2.0/25",
								"option":  "orlonger",
							}),
						resource.TestCheckResourceAttr("junos_policyoptions_policy_statement.testacc_policyOptions",
							"from.source_address_filter_list.#", "1"),
						resource.TestCheckTypeSetElemAttr("junos_policyoptions_policy_statement.testacc_policyOptions",
							"from.source_address_filter_list.*", "testacc policyOptions"),
						resource.TestCheckResourceAttr("junos_policyoptions_policy_statement.testacc_policyOptions",
							"to.bgp_as_path.#", "1"),
						resource.TestCheckTypeSetElemAttr("junos_policyoptions_policy_statement.testacc_policyOptions",
						...
						resource.TestCheckResourceAttr("junos_policyoptions_policy_statement.testacc_policyOptions",
							"term.0.from.prefix_list_filter.#", "2"),
						resource.TestCheckTypeSetElemNestedAttrs("junos_policyoptions_policy_statement.testacc_policyOptions",
							"term.0.from.prefix_list_filter.*", map[string]string{
						...
						resource.TestCheckTypeSetElemNestedAttrs("junos_policyoptions_policy_statement.testacc_policyOptions",
							"term.0.from.route_filter.*", map[string]string{
								"route":  "192.0.2.0/25",
								"option": "exact",
							}),
						resource.TestCheckTypeSetElemNestedAttrs("junos_policyoptions_policy_statement.testacc_policyOptions",
						...
						resource.TestCheckResourceAttr("junos_policyoptions_policy_statement.testacc_policyOptions",
							"term.0.from.route_filter_list.#", "1"),
						resource.TestCheckTypeSetElemAttr("junos_policyoptions_policy_statement.testacc_policyOptions",
							"term.0.from.route_filter_list.*", "testacc policyOptions"),
						resource.TestCheckResourceAttr("junos_policyoptions_policy_statement.testacc_policyOptions",
							"term.0.from.source_address_filter.#", "2"),
						resource.TestCheckTypeSetElemNestedAttrs("junos_policyoptions_policy_statement.testacc_policyOptions",
							"term.0.from.source_address_filter.*", map[string]string{
								"address": "192.0.2.0/25",
								"option":  "exact",
							}),
						resource.TestCheckTypeSetElemNestedAttrs("junos_policyoptions_policy_statement.testacc_policyOptions",
						...
						resource.TestCheckResourceAttr("junos_policyoptions_policy_statement.testacc_policyOptions",
							"term.0.from.source_address_filter_list.#", "1"),
						resource.TestCheckTypeSetElemAttr("junos_policyoptions_policy_statement.testacc_policyOptions",
							"term.0.from.source_address_filter_list.*", "testacc policyOptions"),
						resource.TestCheckResourceAttr("junos_policyoptions_policy_statement.testacc_policyOptions",
				...
				},
				{
					...
					Check: resource.ComposeTestCheckFunc(
						...
						resource.TestCheckResourceAttr("junos_policyoptions_route_filter_list.testacc_policyOptions2",
							"address.#", "0"),
						resource.TestCheckResourceAttr("junos_policyoptions_route_filter_list.testacc_policyOptions2",
							"dynamic_db", "true"),
						resource.TestCheckResourceAttr("junos_policyoptions_source_address_filter_list.testacc_policyOptions2",
							"address.#", "0"),
						resource.TestCheckResourceAttr("junos_policyoptions_source_address_filter_list.testacc_policyOptions2",
							"dynamic_db", "true"),
						resource.TestCheckResourceAttr("junos_policyoptions_policy_statement.testacc_policyOptions",
				...
				{
					ResourceName:      "junos_policyoptions_route_filter_list.testacc_policyOptions",
					ImportState:       true,
					ImportStateVerify: true,
				},
				{
					ResourceName:      "junos_policyoptions_source_address_filter_list.testacc_policyOptions",
					ImportState:       true,
					ImportStateVerify: true,
				},
			},
