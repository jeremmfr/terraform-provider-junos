...
func TestAccResourceSystemSyslogFile_writeOnly(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck:                 func() { testAccPreCheck(t) },
		ProtoV5ProviderFactories: testAccProtoV5ProviderFactories,
		...
		Steps: []resource.TestStep{
			{
				...
				ConfigDirectory: config.TestStepDirectory(),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckNoResourceAttr("junos_system_syslog_file.testacc_syslogFile_wo",
						"archive.sites.1.password"),
					resource.TestCheckNoResourceAttr("junos_system_syslog_file.testacc_syslogFile_wo",
						"archive.sites.1.password_wo"),
					resource.TestCheckResourceAttr("junos_system_syslog_file.testacc_syslogFile_wo",
						"archive.sites.1.password_wo_version", "1"),
				),
			},
			{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("junos_system_syslog_file.testacc_syslogFile_wo",
						"archive.sites.1.password_wo_version", "2"),
				),
			},
		},
	})
