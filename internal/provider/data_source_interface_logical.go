		...
		Attributes: map[string]schema.Attribute{
			...
			"family_inet": schema.ObjectAttribute{
				...
				AttributeTypes: map[string]attr.Type{
					...
					"filter_input_list":  types.ListType{}.WithElementType(types.StringType),
					"filter_output":      types.StringType,
					"filter_output_list": types.ListType{}.WithElementType(types.StringType),
					"mtu":                types.Int64Type,
...
func (dsc *interfaceLogicalDataSource) searchName(
	ctx context.Context, configInterface, match string, junSess *junos.Session,
) (string, error) {
