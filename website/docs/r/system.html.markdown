...
* `services` - (Optional)([attribute-as-blocks mode](https://www.terraform.io/docs/configuration/attr-as-blocks.html)) Can be specified only once to declare 'services' configuration.
  ...
  * `web_management_http` - (Optional)([attribute-as-blocks mode](https://www.terraform.io/docs/configuration/attr-as-blocks.html)) Can be specified only once to declare 'web_management_http' configuration.
  ...
  * `web_management_https` - (Optional)([attribute-as-blocks mode](https://www.terraform.io/docs/configuration/attr-as-blocks.html)) Can be specified only once to declare 'web_management_https' configuration.
    * `interface` - (Optional)(`ListOfString`) Specify the name of one or more interfaces.
